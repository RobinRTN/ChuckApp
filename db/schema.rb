...
ActiveRecord::Schema[7.0].define(version: 2023_02_10_105616) do
  ...
  create_table "client_bookings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["booking_id"], name: "index_client_bookings_on_booking_id"
  ...
  add_foreign_key "client_bookings", "bookings"
